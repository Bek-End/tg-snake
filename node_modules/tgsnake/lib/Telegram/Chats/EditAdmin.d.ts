 ...
 */
export declare function EditAdmin(snakeClient: Snake, chatId: bigint | number | string, userId: bigint | number | string, more?: editAdminMoreParams): Promise<Updates.UpdateNewMessage | Updates.UpdateNewChannelMessage | undefined>;
