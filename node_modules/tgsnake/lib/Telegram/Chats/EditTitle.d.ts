 ...
 */
export declare function EditTitle(snakeClient: Snake, chatId: bigint | number | string, title: string): Promise<Api.TypeUpdates | Updates.UpdateNewMessage | Updates.UpdateNewChannelMessage | undefined>;
