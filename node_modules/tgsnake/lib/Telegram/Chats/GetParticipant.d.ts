 ...
 * ```
 */
export declare function GetParticipant(snakeClient: Snake, chatId: number | string | bigint, userId: number | string | bigint): Promise<import("../../Utils/ChatParticipants").TypeChatParticipant>;
