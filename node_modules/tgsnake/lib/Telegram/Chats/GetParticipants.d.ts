 ...
 * ```
 */
export declare function GetParticipants(snakeClient: Snake, chatId: number | string | bigint, more?: GetParticipantMoreParams): Promise<ChatParticipants | undefined>;
