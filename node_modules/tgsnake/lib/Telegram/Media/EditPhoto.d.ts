 ...
 * ```
 */
export declare function EditPhoto(snakeClient: Snake, chatId: number | string | bigint, photo: string | Buffer): Promise<Api.TypeUpdates | Updates.UpdateNewMessage | Updates.UpdateNewChannelMessage | undefined>;
