 ...
 * ```
 */
async function SendDocument(snakeClient, chatId, fileId, more) {
    ...
    try {
        ...
        switch (fileId.constructor) {
            case Buffer:
                ...
                return await (0, SendMedia_1.SendMedia)(snakeClient, chatId, new telegram_1.Api.InputMediaUploadedDocument(Object.assign({ 
                    ...
                    //@ts-ignore
                    mimeType: bufferInfo.mime || (more === null || more === void 0 ? void 0 : more.mimeType) || 'application/zip', attributes: [
                        new telegram_1.Api.DocumentAttributeFilename({
                            fileName: (_a = more === null || more === void 0 ? void 0 : more.filename) !== null && _a !== void 0 ? _a : 'unknown',
                        }),
                    ], forceFile: (_b = more === null || more === void 0 ? void 0 : more.forceDocument) !== null && _b !== void 0 ? _b : true }, (more && more.thumbnail && validateThumb(more.thumbnail)
                    ? {
            ...
            case String:
                ...
                if (/^http/i.test(String(fileId)) || /^(\/|\.\.?\/|~\/)/i.test(String(fileId))) {
                    let download = (_c = more === null || more === void 0 ? void 0 : more.download) !== null && _c !== void 0 ? _c : false;
                    ...
                    return await (0, SendMedia_1.SendMedia)(snakeClient, chatId, new telegram_1.Api.InputMediaUploadedDocument(Object.assign({ 
                        ...
                        file: await (0, UploadFile_1.UploadFile)(snakeClient, fileInfo.source, {
                            workers: (more === null || more === void 0 ? void 0 : more.workers) || 1,
                            fileName: (_d = more === null || more === void 0 ? void 0 : more.filename) !== null && _d !== void 0 ? _d : basename,
                            onProgress: more === null || more === void 0 ? void 0 : more.onProgress,
                        }), 
                        //@ts-ignore
                        mimeType: fileInfo.mime || (more === null || more === void 0 ? void 0 : more.mimeType) || 'application/zip', attributes: [
                            new telegram_1.Api.DocumentAttributeFilename({
                                fileName: (_e = more === null || more === void 0 ? void 0 : more.filename) !== null && _e !== void 0 ? _e : 'unknown',
                            }),
                        ], forceFile: (_f = more === null || more === void 0 ? void 0 : more.forceDocument) !== null && _f !== void 0 ? _f : true }, (more && more.thumbnail && validateThumb(more.thumbnail)
                        ? {
                            thumb: await (0, UploadFile_1.UploadFile)(snakeClient, more.thumbnail, {
                                workers: more.workers || 1,
                            }),
        ...
        throw new Error_1.default(error.message, 'telegram.sendDocument', `${chatId},${Buffer.isBuffer(fileId) ? `<Buffer ${fileId.toString('hex')}>` : JSON.stringify(fileId)}${more ? ',' + JSON.stringify(more) : ''}`);
    }
}
