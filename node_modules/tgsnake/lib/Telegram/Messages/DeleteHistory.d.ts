 ...
 * ```
 */
export declare function DeleteHistory(snakeClient: Snake, chatId: number | string | bigint, more?: deleteHistoryMoreParams): Promise<Api.TypeUpdates | ResultAffectedMessages>;
