...
export declare class ResultAffectedMessages {
    pts?: number;
    ptsCount?: number;
    offset?: number;
    date: Date | number;
 ...
 * ```
 */
export declare function DeleteMessages(snakeClient: Snake, chatId: number | string | bigint, messageId: number[]): Promise<ResultAffectedMessages>;
