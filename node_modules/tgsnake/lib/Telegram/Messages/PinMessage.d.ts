 ...
 * ```
 */
export declare function PinMessage(snakeClient: Snake, chatId: number | string | bigint, messageId: number, more?: pinMessageMoreParams): Promise<Updates.UpdateNewMessage | Updates.UpdateNewChannelMessage | Api.UpdatePinnedMessages | Api.UpdatePinnedChannelMessages | undefined>;
