...
type TypeUpdate = ResultGetEntity | MessageContext | UpdateChatParticipants | UpdateChatUserTyping | UpdateDeleteMessages | UpdateMessageID | UpdateNewMessage | UpdateShortChatMessage | UpdateShortMessage | UpdateShortSentMessage | UpdateUserStatus | UpdateUserTyping | UpdateNewChannelMessage | UpdateInlineBotCallbackQuery | UpdateBotCallbackQuery | UpdateBotInlineQuery | UpdateBotPrecheckoutQuery | UpdateEditChannelMessage | UpdateEditMessage;
interface Context {
    '*': TypeUpdate;
...
export { TypeUpdates, TypeUpdate, UpdateChatParticipants, UpdateChatUserTyping, UpdateDeleteMessages, UpdateMessageID, UpdateNewMessage, UpdateShortChatMessage, UpdateShortMessage, UpdateShortSentMessage, UpdateUserStatus, UpdateUserTyping, UpdateNewChannelMessage, Context, UpdateInlineBotCallbackQuery, UpdateBotCallbackQuery, UpdateBotInlineQuery, UpdateEditChannelMessage, UpdateEditMessage, UpdateBotPrecheckoutQuery, };
