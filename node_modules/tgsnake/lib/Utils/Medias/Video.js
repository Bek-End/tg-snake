...
class MediaVideo extends Media_1.Media {
    constructor() {
        super();
        this['_'] = 'video';
    }
    async encode(video, snakeClient) {
        var _a;
        ...
        this.size = BigInt(String(video.size));
        this.dcId = video.dcId;
        for (let attribute of video.attributes) {
            if (attribute instanceof telegram_1.Api.DocumentAttributeVideo) {
                attribute;
                this.supportStreaming = (_a = attribute.supportsStreaming) !== null && _a !== void 0 ? _a : false;
            ...
            if (attribute instanceof telegram_1.Api.DocumentAttributeHasStickers) {
                attribute;
    ...
    async download(fileId, params) {
        ...
        if (!file) {
            ...
            throw new Error_1.default('FileId not found!', 'Video.download', String(file));
        }
        if (file !== this.fileId) {
            let dFile = this.decode(file);
            if (dFile.typeId !== 4) {
                this.snakeClient.log.error('Failed to download video cause: Miss match file type!');
                throw new Error_1.default('Miss match file type!', 'Video.download', String(file));
            }
