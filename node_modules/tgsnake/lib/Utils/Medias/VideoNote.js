...
class MediaVideoNote extends Media_1.Media {
    constructor() {
        super();
        this['_'] = 'videoNote';
    }
    async encode(videoNote, snakeClient) {
        var _a;
    ...
    async download(fileId, params) {
        ...
        if (!file) {
            ...
            throw new Error_1.default('FileId not found!', 'VideoNote.download', String(file));
        }
        if (file !== this.fileId) {
            let dFile = this.decode(file);
            if (dFile.typeId !== 13) {
                this.snakeClient.log.error('Failed to download videoNote cause: Miss match file type!');
                throw new Error_1.default('Miss match file type!', 'VideoNote.download', String(file));
            }
...
exports.MediaVideoNote = MediaVideoNote;
