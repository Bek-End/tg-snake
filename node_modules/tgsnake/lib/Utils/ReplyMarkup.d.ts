...
export declare function BuildReplyMarkup(replyMarkup: TypeReplyMarkup, snakeClient: Snake): Promise<Api.ReplyInlineMarkup | Api.ReplyKeyboardMarkup | Api.ReplyKeyboardHide | Api.ReplyKeyboardForceReply | undefined>;
export declare function convertReplyMarkup(replyMarkup: Api.TypeReplyMarkup, SnakeClient: Snake): Promise<TypeReplyMarkup | undefined>;
